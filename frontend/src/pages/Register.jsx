...
/**
 * Intervue AI — Registration page.
 * Restructured with active API handlers, 3D card tilt, and adaptive light/dark layout.
 * Left: kinetic telemetry stage.
 * Right: glass card for user sign up.
 */
export default function Register() {
  ...
  // 3D tilt values for the registration card
            ...
            <div className="relative rounded-3xl border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-[#0F1524]/80 p-6 sm:p-8 backdrop-blur-2xl shadow-[0_30px_100px_-20px_rgba(15,23,42,0.08)] dark:shadow-[0_40px_120px_-30px_rgba(0,0,0,0.8)] transition-all">
              ...
              <div className="text-center">
                ...
                <p className="mt-1 text-[13.5px] text-slate-500 dark:text-white/55">
                  Create a free mock practice account
                </p>
              </div>

              {/* Form */}
              <form onSubmit={handleSubmit} className="mt-6 space-y-3.5">
                <Field label="Full Name" testId="name-field">
                  <input
                    type="text"
                    required
                    value={name}
                ...
                <Field label="Confirm Password" testId="confirm-password-field">
                  <input
                ...
                {/* Login Redirect */}
                <p className="pt-2 text-center text-[13px] text-slate-500 dark:text-white/55">
                ...
                <div className="flex justify-center pt-1">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.24em] text-slate-500 dark:text-white/55 hover:text-slate-900 dark:hover:text-white cursor-pointer"
                  >
...
function Field({ label, children, testId }) {
  return (
    <label data-testid={testId} className="block text-left">
...
function OAuthButton({ children, label, testId, variant = "google-brand", onClick }) {
  const styles =
    variant === "github-brand"
      ? "bg-slate-950 dark:bg-white text-white dark:text-[#0B0F19] hover:opacity-90 w-full"
      : "bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-white border border-slate-200 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/[0.04] w-full";
  return (
    <button
      type="button"
      onClick={onClick}
...
function LeftStage() {
  ...
  return (
    <div className="relative text-left">
      ...
      >
        Create your profile in seconds. Calibrate your microphone and cameras, parse your CV parameters, and unlock premium practice tracks immediately.
      </motion.p>
      ...
      >
        {[
          { k: "Active", u: "System Status" },
          { k: "0+ reps", u: "Rehearsals completed" },
          { k: "Free", u: "Practice lobby access" },
        ].map((s) => (
